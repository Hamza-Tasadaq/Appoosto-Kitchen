...
const Categories = ({
  ...
  return (
    <div className="flex noScrollBar md:cursor-pointer justify-between flex-nowrap items-center overflow-auto lg:space-x-4">
      {CategoriesData.map(({ iconSrc, name, background }, index) => (
        <div
          ...
          key={index}
          className={`rounded-lg duration-300 h-28 min-w-[150px] w-full bg-opacity-20 flex  items-center justify-center flex-col lg:m-0`}
        >
